...
from PySide6.QtWidgets import (
    ...
    QComboBox, QPushButton, QGroupBox, QFormLayout, QSplitter,
    QDoubleSpinBox,
)
...
class IDPhotoView(QWidget):
    ...
    def _create_controls(self) -> QWidget:
        ...
        layout.addRow("照片尺寸:", self._size_combo)
        ...
        layout.addRow("亮度调整:", bright_layout)
        ...
        contrast_layout.addWidget(self._contrast)
        layout.addRow("对比度调整:", contrast_layout)
    ...
    def _start(self) -> None:
        ...
        for fp in files:
            ...
            self._task_progress.add_task(task.task_id, "id_photo", fp.name)
